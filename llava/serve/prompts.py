...
attr_gen_image = '''
What are useful visual features for distinguishing this organism in the photo? Provide the answer as lists of required and likely attributes. For example, for a school bus you might say:
Required:
- yellow
- black
- wheels
