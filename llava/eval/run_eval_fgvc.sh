...
echo "model_name ['llava-7b', 'llava-13b', 'ferret-7b', 'ferret-13b', 'gpt-4']"
read model_name
...
elif [ "$dataset_name" = "ferret-7b" ]; then
	model_name_var=""
elif [ "$dataset_name" = "ferret-13b" ]; then
	model_name_var=""
elif [ "$dataset_name" = "gpt-4" ]; then
